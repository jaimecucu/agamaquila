...
class contenidoForm(forms.ModelForm):
    class Meta:
        model =contenido
        exclude = ('hora_salida', 'hora_fin_carga') # Excluimos estos campos
        ...
        widgets = {
            ...
            'sin_hoyos': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'sin_parches': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'sin_salientes': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'sin_laminas': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),

            #puertas en buen estado

            'puertas_empaques': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'puertas_hermetico': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'puertas_salientes': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'puertas_laminas': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),

            #condiciones de higiene

            'higiene_limpios': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'higiene_olores': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'higiene_plagas': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),

            #paredes en buen estado

            'paredes_hoyos': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'paredes_parches': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'paredes_salientes': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'paredes_laminas': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),

             #techos en buen estado

            'techos_hoyos': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'techos_salientes': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),
            'techos_laminas': forms.Select(choices=[('A', 'ECEPTADO'), ('C', 'CRITICA')]),

             #condiciones externas

             'externas_llantas': forms.Select(choices=[('A', 'ECEPTADO'), ('-', 'NO APLICA')]),
             'externas_refaccion': forms.Select(choices=[('A', 'ECEPTADO'), ('-', 'NO APLICA')]),
             'externas_patines': forms.Select(choices=[('A', 'ECEPTADO'), ('-', 'NO APLICA')]),
             'externas_luces': forms.Select(choices=[('A', 'ECEPTADO'), ('-', 'NO APLICA')]),
             'externas_tanque': forms.Select(choices=[('A', 'ECEPTADO'), ('-', 'NO APLICA')]),
...
class contenido2Form(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            #puntos de revision 
            #pisos en buen estado
            'sin_hoyos': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'sin_parches': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'sin_salientes': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'sin_laminas': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),

            #puertas en buen estado

            'puertas_empaques': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'puertas_hermetico': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'puertas_salientes': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'puertas_laminas': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),

            #condiciones de higiene

            'higiene_limpios': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'higiene_olores': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'higiene_plagas': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),

            #paredes en buen estado

            'paredes_hoyos': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'paredes_parches': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'paredes_salientes': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'paredes_laminas': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),

             #techos en buen estado

            'techos_hoyos': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'techos_salientes': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),
            'techos_laminas': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'CRITICA')]),

             #condiciones externas

             'externas_llantas': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'NO APLICA')]),
             'externas_refaccion': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'NO APLICA')]),
             'externas_patines': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'NO APLICA')]),
             'externas_luces': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'NO APLICA')]),
             'externas_tanque': forms.Select(choices=[('A', 'ECEPTADO'), ('B', 'NO APLICA')]),
