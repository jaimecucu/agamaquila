"""
Django settings for maquilas project.
...
MEDIA_ROOT = BASE_DIR/'media/' # ruta de los archivos subidos
...
SECRET_KEY = 'django-insecure-wwyldjd4jqc7m&ay%e8nevsci=$rxxyzh7494i+dgwrp&bcmbr'
...
WSGI_APPLICATION = 'maquilas.wsgi.application'
